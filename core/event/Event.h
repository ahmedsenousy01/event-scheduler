...
public:
    ...
    void displayDetails() {
        ...
        cout << "Start Time: " << this->getStartDateTime().getTime().getHour() << ":" << this->getStartDateTime().getTime().getMinute() << endl;
        cout << "End Date: " << this->getEndDateTime().getDate().getMonth() << "/" << this->getEndDateTime().getDate().getDay() << endl;
        cout << "End Time: " << this->getEndDateTime().getTime().getHour() << ":" << this->getEndDateTime().getTime().getMinute() << endl;
        cout << "Reminder Time: " << this->getReminderTime().getHour() << ":" << this->getReminderTime().getMinute() << endl;
